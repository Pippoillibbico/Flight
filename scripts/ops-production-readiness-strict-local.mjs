...
async function main() {
  ...
  const strictLocalEnv = {
    ...
    ENABLE_PROVIDER_KIWI: process.env.ENABLE_PROVIDER_KIWI || 'true',
    ...
    KIWI_API_KEY: process.env.KIWI_API_KEY || 'kiwi_local_ops_key_123456789',
    FLIGHT_SCAN_ENABLED: process.env.FLIGHT_SCAN_ENABLED || 'true',
    FLIGHT_SCAN_RUN_DOWNSTREAM: process.env.FLIGHT_SCAN_RUN_DOWNSTREAM || 'true',
